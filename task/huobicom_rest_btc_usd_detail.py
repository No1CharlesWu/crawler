...
huobicom_rest_btc_usd_detail_last_md5 = 0


class Task(taskbase.TaskBase):
    def do(self):
        print('huobicom_rest_btc_usd_detail')
        ...
        try:
            data = huobi_spot.get_detail(huobi_api.DETAIL_BTC_USD)
    ...
    def data_filter(self, data):
        global huobicom_rest_btc_usd_detail_last_md5
        data_md5 = huobi_api.get_md5_value(str(data))
        if data_md5 == huobicom_rest_btc_usd_detail_last_md5:
            return None
        else:
            huobicom_rest_btc_usd_detail_last_md5 = data_md5
