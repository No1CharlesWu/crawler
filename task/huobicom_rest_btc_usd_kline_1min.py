...
huobi_rest_btc_usd_kline_1min_last_timestamp = 0
...
class Task(taskbase.TaskBase):
    def do(self):
        ...
        try:
            data = huobi_spot.get_kline(huobi_api.KLINE_BTC_USD, '001', 5)
    ...
    def data_filter(self, data):
        global huobi_rest_btc_usd_kline_1min_last_timestamp
        r = list()
        for i in range(len(data) - 1):
            ...
            # print(d, t_date, huobi_rest_btc_usd_kline_1min_last_timestamp)
            if t_date > huobi_rest_btc_usd_kline_1min_last_timestamp:
                huobi_rest_btc_usd_kline_1min_last_timestamp = t_date
