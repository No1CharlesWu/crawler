...
huobicom_rest_ltc_cny_depth_last_id = 0


class Task(taskbase.TaskBase):
    def do(self):
        print('huobicom_rest_ltc_cny_depth')
        ...
        try:
            data = huobi_spot.get_depth(huobi_api.DEPTH_LTC_CNY, 20)
    ...
    def data_filter(self, data):
        global huobicom_rest_ltc_cny_depth_last_id
        if huobicom_rest_ltc_cny_depth_last_id == data['id']:
            return None
        else:
            huobicom_rest_ltc_cny_depth_last_id = data['id']
