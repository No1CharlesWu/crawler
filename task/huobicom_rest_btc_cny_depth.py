...
class Task(taskbase.TaskBase):
    def do(self):
        ...
        try:
            data = huobi_spot.get_depth(huobi_api.DEPTH_BTC_CNY, 20)
    ...
    def data_filter(self, data):
        global huobicom_rest_btc_cny_depth_last_id
        if huobicom_rest_btc_cny_depth_last_id == data['id']:
            return None
        else:
            huobicom_rest_btc_cny_depth_last_id = data['id']
