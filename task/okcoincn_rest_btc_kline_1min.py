...
okcoincn_rest_btc_kline_1min_last_timestamp = 0
...
class Task(taskbase.TaskBase):
    def do(self):
        ...
        try:
            data = okcoin_spot.kline(symbol='btc_cny', type='1min', size=5,
    ...
    def data_filter(self, data):
        ...
        for i in range(len(data)):
            ...
            r.append(temp_d)
            global okcoincn_rest_btc_kline_1min_last_timestamp
            okcoincn_rest_btc_kline_1min_last_timestamp = data[i][0]
        r.pop()
        return r
