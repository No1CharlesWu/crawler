...
class Task(taskbase.TaskBase):
    def do(self):
        ...
        :return:
        """
        print('okcoinccm_rest_btc_trades')
        ...
        try:
            data = okcoin_spot.trades(symbol='btc_usd', since=okcoincom_rest_btc_trades_last_tid)
    ...
    def data_filter(self, data):
        ...
        for d in data:
            ...
            okcoincom_rest_btc_trades_last_tid = int(d['tid'])
